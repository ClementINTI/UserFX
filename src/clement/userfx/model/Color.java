...
public class Color {
	...
	/**
	 * tableau de caractères de taille 6 avec les cases 0 et 1 pour le rouge, 2 et
	 * 3 pour le vert et 4 et 5 pour le bleu en hexadécimal.
	 */
	 ...
	 * 
	 * @param red   le rouge entre 0-255
	 * @param green le vert entre 0-255
	 * @param blue  le bleu entre 0-255
	 */
	 ...
	 * 
	 * @param hexValue valeur hexa décimale de la couleur (eg. "#F2AA76").
	 */
	...
	/**
	 * Méthode permettant de mettre à jour la valeur hexa à partir d'une chaîne
	 * de caractère bien formée.
	 * 
	 * @param s la chaîne bien formée
	 */
	...
	/**
	 * Récupère la valeur décimal d'un élément hexa, exemple : '1' -> 1, 'A' ->
	 * 10.
	 * 
	 ...
	 * 
	 * @param red nouvelle valeur de rouge entre 0-255
	 */
	 ...
	 * 
	 * @param green nouvelle valeur de vert entre 0-255
	 */
	 ...
	 * 
	 * @param blue nouvelle valeur de bleu entre 0-255
	 */
